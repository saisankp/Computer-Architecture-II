...
// Multiple_k
//
void multiple_k_c(uint16_t M, uint16_t N, uint16_t K, uint16_t* array)
{
...
int main() {
	...
	multiple_k_c(M1, N1, K1, array_N2);
	for (uint16_t i = 0; i < N1; ++i)
		std::cout << array_N2[i] << " ";
	...
	std::cout << "Array of multiples by C++: \n";
	multiple_k_c(M2, N2, K2, array_N4);
	for (uint16_t i = 0; i < N2; ++i)
		std::cout << array_N4[i] << " ";
	std::cout << "\n";

	std::cout << "Array of multiples by Assembly: \n";
	multiple_k(M2, N2, K2, array_N3);
	for (uint16_t i = 0; i < N2; ++i)
		std::cout << array_N3[i] << " ";
	std::cout << "\n";
